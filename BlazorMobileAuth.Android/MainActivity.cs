...
using BlazorMobileAuth.AppPackage;
using BlazorMobile.Droid.Platform;

namespace BlazorMobileAuth.Droid
{
    [Activity(Label = "BlazorMobileAuth", Icon = "@mipmap/icon", Theme = "@style/MainTheme", MainLauncher = true, ConfigurationChanges = ConfigChanges.ScreenSize | ConfigChanges.Orientation)]
